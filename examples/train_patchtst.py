#!/usr/bin/env python3
"""
PatchTST Model - Training & Evaluation

Self-contained script to train PatchTST model.
...
def main():
    """Main training function for PatchTST."""
    # Use PatchTST config file
    config_path = Path(__file__).parent / "configs/patchtst.yaml"
    
    print("=" * 80)
    print("PatchTST Model - Training Pipeline")
    print("=" * 80)
