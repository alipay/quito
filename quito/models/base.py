...
from quito.config.training import TrainingConfig
...
class BaseModel(nn.Module, ABC):
    ...
    def __init__(self, config: ModelConfig, local_rank: int):
        """
    ...
    def setup_loss_fn(self, loss_fn, loss_kwargs):
        ...
        self.loss_fn = partial(get_metric_fn(loss_fn), **loss_kwargs)
